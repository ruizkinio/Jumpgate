...
- Public release remains blocked until production deployment, representative provider
  and subtitle UAT, repeated external-player lifecycle UAT, stable APK signing, both
  ABI artifact audits, and clean public repository candidates are complete.
